...
import { createNotExecutedCondition, createAndCondition, createHistoricalCondition, createPeakReachedCondition, createDrawdownFromPeakCondition, } from '../conditions/tradingConditions.js';
/**
 ...
 * ```
 */
export function createMaxDrawdownFromPeakTemplate(params) {
    ...
    if (minCurrent !== undefined) {
        ...
        conditions.push(AtomicCondition.create(field, Operator.GREATER_EQUAL, minCurrent.value, `${field}_min_current_check`));
    }
...
//# sourceMappingURL=maxDrawdownFromPeak.js.map