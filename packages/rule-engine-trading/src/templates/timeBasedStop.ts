 ...
 * ```
 */
export function createTimeBasedStopTemplate(params: TimeBasedStopTemplateParams): RuleTemplate {
  ...
  const timeCondition = AtomicCondition.create(
    'elapsedMinutes',
  ...
  const profitNotReachedCondition = AtomicCondition.create(
    'currentR',
    Operator.LESS_THAN,
    minProfitR,
